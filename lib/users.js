...
module.exports = api => {
  return {
     ...
     * @example
     * const { meta, data } = await tavrn.user("me");
     ...
     * @example
     * const { meta, data } = await tavrn.avatar("me");
     * @param {string|Number} userId - A user id
     ...
     *
     * @example
     * const { meta, data } = await tavrn.cover("me");
     * @param {string|Number} userId - A user id
     * @param {boolean} [true] - Should the return value be prebuffered via the fetch API?
     * @returns {Promise}
     */
     ...
     *
     * @example
     * const { meta, data } tavrn.users(1,15,127);
     ...
     *
     * @example
     * const { meta, data } = await tavrn.mentions(1);
     * @param {string|Number} userid - A user id
     * @param {Object} [params] - Additional URI parameters
     * @returns {Promise}
     */
     ...
     *
     * @example
     * const { meta, data } = tavrn.postsFrom(1);
     * @param {string|Number} userId - A user id
     * @param {Object} [params] - Additional URI parameters
     * @returns {Promise}
     */
     ...
     *
     * @example
     * const { meta, data } = await tavrn.replaceProfile({
     ...
     *
     * @example
     * const { meta, data } = await tavrn.updateProfile({
     *   timezone: "Europe/Berlin",
     *   name: "Robert"
     * });
     ...
     *
     * @example
     * const { meta, data } = await tavrn.following(1);
     * @param {string|Number} userId - A user id
     * @param {Object} [params] - Additional URI parameters
     * @returns {Promise}
     */
     ...
     *
     * @example
     * const { meta, data } = await tavrn.followers(1);
     * @param {string|Number} userId - A user id
     * @param {Object} [params] - Additional URI parameters
     * @returns {Promise}
     */
     ...
     *
     * @example
     * const { meta, data } = await tavrn.follow(1);
     ...
     *
     * @example
     * const { meta, data } = await const { meta, data } = await tavrn.unfollow(1);
     ...
     *
     * @example
     * const { meta, data } = await tavrn.muted();
     * @param {Object} [params] - Additional URI parameters
     * @returns {Promise}
     */
    muted(params = {}) {
     ...
     *
     * @example
     * const { meta, data } = await tavrn.mute(1);
     ...
     *
     * @example
     * const { meta, data } = await tavrn.unmute(1);
     ...
     *
     * @example
     * const { meta, data } = await tavrn.blocked();
     * @param {Object} [params] - Additional URI parameters
     * @returns {Promise}
     */
    blocked(params = {}) {
     ...
     *
     * @example
     * const { meta, data } = await tavrn.block(1);
     ...
     *
     * @example
     * const { meta, data } = await tavrn.unblock(1);
     ...
     *
     * @example
     * const { meta, data } = await tavrn.presence();
     * @param {Object} [params] - Additional URI parameters
     * @returns {Promise}
     */
    presence(params = {}) {
     ...
     *
     * @example
     * const { meta, data } = await tavrn.searchUsers({
     *  q: "news",
     *  types: "feed"
     * });
     * @param {Object} params
