...
module.exports = api => {
  return {
     ...
     */
    global(params = {}) {
      return api.request(`/posts/stream/global`, { params: params });
    },
     ...
     */
    personal(params = {}) {
      return api.request("/posts/stream", { params: params });
    },
     ...
     */
    unified(params = {}) {
      return api.request("/posts/stream/unified", { params: params });
    },
    ...
    thread(postId, params = {}) {
      return api.request(`/posts/${postId}/replies`, { params: params });
    },
     ...
     *
     * @example
     * tavrn.createPost("An awesome post").then(res => {
     *  console.log(res);
     * });
     * @example
     * tavrn.createPost("An awesome post", {nsfw: true}).then(res => {
     *  console.log(res);
     * });
     * @example
     * tavrn.createPost("An awesome post", {
     *  nsfw: true
     *  replyTo: 1234,
     *  parseLinks: false,
     ...
     *
     * @example
     * tavrn.updatePost(123, updatedText);
     * @param {string|Number} postId - A post id
    ...
    bookmarks(userId, params = {}) {
      return api.request(`/users/${userId}/stars`, { params: params });
    },
     ...
     */
    bookmark(postId) {
      return api.request(`/posts/${postId}/star`, {
        httpMethod: "PUT"
      });
    },
